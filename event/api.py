...
class ShareEventViewSet(mixins.CreateModelMixin, mixins.ListModelMixin,
	...
	def post_save(self, obj, created=False):
		msg = '¡Enhorabuena! Has sido invitado a participar en el evento ' + str(obj.event.title) + '. Visita esta dirección para poder participa: http://52.10.18.150/#/eventos/' + str(obj.event.id)
